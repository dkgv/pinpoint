...
{
    public abstract class AbstractCommand<T> : MarkupExtension, ICommand where T : class, ICommand, new()
    {
        /// <summary>
        ...
        protected Window GetTaskbarWindow(object commandParameter)
        {
            ...
            return !(commandParameter is TaskbarIcon tb) ? null : TryFindParent<Window>(tb);
        }
